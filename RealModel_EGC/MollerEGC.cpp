...
//Acccept the algorithm and code, which are published by Tomas Moller
...
int CMollerEGC::coplanar_tri_tri(double N[3],double V0[3],double V1[3],double V2[3],
                     double U0[3],double U1[3],double U2[3])
{
   double A[3];
   short i0,i1;
...
int CMollerEGC::tri_tri_intersect(double V0[3],double V1[3],double V2[3],
                      double U0[3],double U1[3],double U2[3])
{
  double E1[3],E2[3];
...
int CMollerEGC::NoDivTriTriIsect(double V0[3],double V1[3],double V2[3],
                     double U0[3],double U1[3],double U2[3])
{
  double E1[3],E2[3];
  double N1[3],N2[3],d1,d2;
...
*/
// Modified by Mei Gang 2010.1.15
void CMollerEGC::isect2(double VTX0[3],double VTX1[3],double VTX2[3],double VV0,double VV1,double VV2,
	    double D0,double D1,double D2,double *isect0,double *isect1,double isectpoint0[3],double isectpoint1[3])
{
  double tmp=D0/(D0-D1);          
  double diff[3];
...
*/
// Modified by Mei Gang 2010.1.15
int CMollerEGC::compute_intervals_isectline(double VERT0[3],double VERT1[3],double VERT2[3],
				       double VV0,double VV1,double VV2,double D0,double D1,double D2,
				       double D0D1,double D0D2,double *isect0,double *isect1,
				       double isectpoint0[3],double isectpoint1[3])
{
...
#define COMPUTE_INTERVALS_ISECTLINE(VERT0,VERT1,VERT2,VV0,VV1,VV2,D0,D1,D2,D0D1,D0D2,isect0,isect1,isectpoint0,isectpoint1) \
  ...
  int CMollerEGC::tri_tri_intersect_with_isectline(double V0[3],double V1[3],double V2[3],
				     double U0[3],double U1[3],double U2[3],int *coplanar,
				     double isectpt1[3],double isectpt2[3])
{
  double E1[3],E2[3];
...
//  double tmp,diff[3];
  ...
  *coplanar = compute_intervals_isectline(V0,V1,V2,vp0,vp1,vp2,dv0,dv1,dv2,
  ...
  // EPSILION Test by MeiGang. 2012.3.3
  for(int i = 0; i < 3; i++) {
	  if(fabs(isectpt1[i]) < EPSILON) isectpt1[i] = 0.0;
	  if(fabs(isectpt2[i]) < EPSILON) isectpt2[i] = 0.0;
  }
  
  return 1;
}
///////////////////////////////////////////////////////////
//Tomas Moller's algorithm and codes for computering triangle-triangle intersection
//2009.12.1 mei gang in freiburg germany